...
# SECRET_KEY = 'django-insecure-#)op+^5@f$wvfws8g*-okb#g)q5y)9bf*%8=on8qg+vp2e(xcz'
...
SPECTACULAR_SETTINGS = {
    ...
    "SECURITY": [{"BearerAuth": []}],
    "SWAGGER_UI_SETTINGS": {
        "persistAuthorization": True,  # keeps token after refresh/reload
    },
}            
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "studentdb"),
